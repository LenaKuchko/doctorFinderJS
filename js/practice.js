...
Practice.prototype.getPractices = function (searchParam) {
  $.get("https://api.betterdoctor.com/2016-03-01/query?query=" + searchParam + "&location=37.773%2C-122.6765%2C10&user_location=37.773%2C-122.6765&skip=0&limit=10&user_key=" + apiKey)
